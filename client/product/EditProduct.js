...
export default function EditProduct({ match }) {
  ...
  return (<div>
    <Card className={classes.card}>
      ...
      <CardActions>
        <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>אישור</Button>
        <Link to={'/seller/shops/edit/' + match.params.shopId} className={classes.submit}><Button variant="contained">ביטול</Button></Link>
      </CardActions>
    </Card>
  </div>)
}
